<?php 
    ...
    $sql = "UPDATE cuenta SET num_ofe_cta ='$num_ofe_cta', num_doc_cta = '$num_doc_cta', nom_cta = '$nom_cta', ape_cta = '$ape_cta', plan_cta = '$plan_cta', cob_cta = '$cob_cta', vlr_cuo_cta = '$vlr_cuo_cta', ctd_ben_cta = '$ctd_ben_cta', obs_cta = '$obs_cta', estado_cta = '$estado_cta' WHERE num_ofe_cta = '$num_ofe_old'";
